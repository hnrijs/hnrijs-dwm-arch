...
static const char col_fg_active[]   = "#cdd6f4"; 

static const char *colors[][3]      = {
    /*               fg             bg          border   */
    [SchemeNorm] = { col_fg,        col_bg,     "#313244" }, 
    [SchemeSel]  = { col_fg_active, col_bg,     "#89b4fa" }, 
};
...
static const char *emojicmd[]       = { "sh", "-c", "$HOME/.config/scripts/rofi-emoji.sh", NULL };
static const char *calecmd[]        = { "sh", "-c", "$HOME/.config/scripts/rofi-calendar.sh", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_d,      spawn,          {.v = dowcmd } },
